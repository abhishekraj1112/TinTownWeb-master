...
@Component({
    selector: 'b2cDashboard',
    templateUrl: './b2cDashboard.component.html',
    styleUrls: ['./b2cDashboard.component.scss'],
    encapsulation: ViewEncapsulation.None,
    animations: pristineAnimations
})
export class B2cDashboardComponent implements OnInit {
    ...
    BindUserActivity() {
        this.webapiHttp.Get(this.webapiHttp.ApiURLArray.DashboardData + 'b2c').then(result => {
