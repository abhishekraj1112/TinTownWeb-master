...
export class SaleorderviewComponent implements OnInit {
    ...
    displayedColumns: string[] = ['item_no', 'ordered_quantity', 'reserved_quantity', 'pick_ready_quantity', 'amount', 'discount', 'total_amount', 'gst_amount', 'grand_total', 'line_status','line_reservation'];
